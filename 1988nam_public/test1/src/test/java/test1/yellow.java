package test1;
	...
	*/
	public class yellow extends TestCase {
	  ...
	  public void setUp() throws Exception {
	    ...
	    driver.get("http://fltybtour.m.11st.co.kr/air/b2cmpg/AIR/NEW/MBL/SKM/AIRNEWMBLSKMMYP0100100010.k1;jsessionid=01F583061EB73406FD0E5E24F7BB926A.skm11?KSESID=air:b2c:SELK138AN:AA024:SKM001:00&pnrseqno=26568");
	  }

	  public void test() throws Exception {
			click(null, By.xpath(".//*[@id='lk_area_1']/p/strong[2]"), MOUSE_LEFT, 1);
			click(null, By.id("btn_expand1"), MOUSE_LEFT, 5);
			click(null, By.id("btn_expand1"), MOUSE_LEFT, 3);
			click(null, By.id("btn_expand1"), MOUSE_LEFT, 2);
			click(null, By.id("btn_expand1"), MOUSE_LEFT, 3);
	  }
