...
// 깃에서 수정 한 것 pull request 되는지 확인 할 주석
/*
...
public class test1 extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    driver.get("http://stage-m.11st.co.kr/MW/html/main.html");
  }

  public void test() throws Exception {
		sendKeys(null, By.id("decSearchKeyword"), "nike", true, 1);
		click(null, By.id("search_submit"), MOUSE_LEFT, 4);
		click(null, By.xpath(".//*[@id='extApp']/button"), MOUSE_LEFT, 8);
  }
